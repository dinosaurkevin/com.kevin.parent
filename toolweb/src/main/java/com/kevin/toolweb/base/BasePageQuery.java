...
public class BasePageQuery extends BaseResp {
	...
	public String getHeadOperType() {
		return headOperType;
	}

	public void setHeadOperType(String headOperType) {
		this.headOperType = headOperType;
	}

	public String getHeadOperExchangeId() {
		return headOperExchangeId;
	}

	public void setHeadOperExchangeId(String headOperExchangeId) {
		this.headOperExchangeId = headOperExchangeId;
	}
	
	public String getHeadOperMemCode() {
		return headOperMemCode;
	}

	public void setHeadOperMemCode(String headOperMemCode) {
		this.headOperMemCode = headOperMemCode;
	}
